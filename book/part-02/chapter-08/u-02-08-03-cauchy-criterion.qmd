...
$$
M=\max\{|a_1|,\ldots,|a_{N_0-1}|,|a_{N_0}|+1\},
$$

便有 $|a_n|\le M$。由 Bolzano--Weierstrass 定理，存在子列 $a_{n_k}\to L$。
...
1. 有界性证明为什么要保留前 $N_0-1$ 项？

::: {.callout-note collapse="true"}
## 答案

Cauchy 条件只控制尾部。前面只有有限项，可以把它们绝对值与尾部统一界一起取最大值。
:::
