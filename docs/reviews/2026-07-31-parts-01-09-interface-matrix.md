...
| 26 | VI | 建立幂级数收敛半径与解析表示 | `ch-08`、`ch-16`、`ch-24`、`ch-25` | `bg-algebra`、`bg-geometry`、`bg-python` | 幂级数与解析工具 → 后续解析计算；为第 27 章提供可选解析对照 | 端点须另判；光滑不等于解析 | 收敛半径、Cauchy–Hadamard、逐项微积分 | `content/chapters/chapter-26/index.md`；`docs/curriculum/part-06-dependencies.md` |
