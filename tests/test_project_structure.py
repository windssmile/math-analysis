...
class ProjectStructureTests(unittest.TestCase):
    def test_required_zensical_shell_files_exist(self):
        required_files = [
            "mkdocs.yml",
            "requirements.txt",
            "content/index.md",
    ...
    def test_pages_workflow_builds_the_zensical_site_without_quarto(self) -> None:
        workflow = (ROOT / ".github/workflows/pages.yml").read_text(encoding="utf-8")
        for marker in (
            "pip install --requirement requirements.txt",
            "make verify",
            "path: site",
            "Install Zensical dependencies",
        ):
