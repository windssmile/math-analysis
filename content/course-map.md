...
截至第 38 章共 173 个学习单元、317 学时。历史发布里程碑包括第 27 章，共 122 个学习单元，
...
第九部规划 21 个核心单元、32 学时（理论 24，应用 8）。当前发布第 37–38 章；
第 39–41 章仍为规划中，不创建正文页面或导航入口。
...
1. `u-09-39-01` 平面场的散度与旋度怎样描述局部变化？（理论 1.50，应用 0.00）
2. `u-09-39-02` Green 公式怎样从简单区域上的微积分基本定理得到？（理论 1.25，应用 0.25）
3. `u-09-39-03` 分片区域、多连通区域与边界方向怎样处理？（理论 1.00，应用 0.50）
4. `u-09-39-04` Green 公式怎样控制面积、环流、通量与路径无关？（理论 0.75，应用 0.75）
