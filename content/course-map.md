...
教材以“定义—证明—算法证书”两条线并行组织。全书已发布至第十二部第 54 章，
共 255 个学习单元、438 学时。第九部闭合时为 189 个学习单元、337 学时。
第十部第 45 章闭合时为 209 个学习单元、367 学时。
...
第六部蓝图为 42 小时（理论 30.5，应用 11.5）。数项级数与函数项级数分阶段叙述：
第 23–24 章先闭合实数项级数，第 25 章才重新引入函数变量和一致收敛。

### [第 23 章：数项级数的收敛与正项判别](chapters/chapter-23/index.md) {#chapter-23}

本章学时：8.5 小时（理论 6.5，应用 2）。

1. [无限求和怎样由部分和定义？](chapters/chapter-23/u-06-23-01-partial-sums.md)
2. [Cauchy 尾部判据怎样控制无限求和？](chapters/chapter-23/u-06-23-02-cauchy-tail.md)
3. [正项级数怎样通过比较判断收敛？](chapters/chapter-23/u-06-23-03-comparison-tests.md)
4. [局部增长率怎样产生比值与根值判别？](chapters/chapter-23/u-06-23-04-ratio-root-tests.md)
5. [积分与凝聚怎样提供判别和余项证书？](chapters/chapter-23/u-06-23-05-integral-condensation.md)
...
1. [向量、内积、范数和距离怎样描述多维几何？](chapters/chapter-28/u-07-28-01-euclidean-geometry.md)
2. [邻域、开集、闭集、内部与边界怎样组织局部和整体？](chapters/chapter-28/u-07-28-02-open-closed-sets.md)
3. [向量序列怎样收敛，有限维空间为什么完备？](chapters/chapter-28/u-07-28-03-sequences-completeness.md)
...
### [第 30 章：高阶微分与多元 Taylor 公式](chapters/chapter-30/index.md) {#chapter-30}

本章学时：7 小时（理论 5.5，应用 1.5）。

1. [二阶微分和 Hessian 为什么是双线性对象？](chapters/chapter-30/u-07-30-01-second-derivative.md)
2. [高阶微分和多重指标怎样组织混合偏导？](chapters/chapter-30/u-07-30-02-higher-derivatives.md)
...
**问题弧：** 怎样把平面与空间区域分解成局部小块，严格定义高维累积量，并通过
降维与坐标变换可靠计算？

第八部 18 个核心单元、32 学时（理论 24，应用 8）已经完整发布；另有一篇不计入
核心学时的选读附录。

### [第 33 章：重积分的定义与可积性](chapters/chapter-33/index.md) {#chapter-33}

本章学时：7 小时（理论 6.25，应用 0.75）。

1. [小矩形上的局部贡献怎样累积成二重积分？](chapters/chapter-33/u-08-33-01-riemann-double-integral.md)
2. [连续函数为什么在闭矩形上可积？](chapters/chapter-33/u-08-33-02-continuous-integrability.md)
3. [线性、序关系与区域可加性怎样成立？](chapters/chapter-33/u-08-33-03-integral-properties.md)
4. [怎样在常用有界区域上定义重积分？](chapters/chapter-33/u-08-33-04-bounded-regions.md)

### [第 34 章：累次积分与计算](chapters/chapter-34/index.md) {#chapter-34}

本章学时：9 小时（理论 6，应用 3）。

1. [矩形上的二重积分为什么可以逐次计算？](chapters/chapter-34/u-08-34-01-iterated-integral-theorem.md)
2. [x-型与 y-型区域怎样写出积分限？](chapters/chapter-34/u-08-34-02-type-i-ii-regions.md)
3. [改变积分次序怎样化简区域与被积函数？](chapters/chapter-34/u-08-34-03-change-order.md)
4. [三重积分怎样按截面或投影逐层计算？](chapters/chapter-34/u-08-34-04-triple-integrals.md)
5. [二维张量积中点法能保证什么、不能保证什么？](chapters/chapter-34/u-08-34-05-tensor-midpoint.md)

### [第 35 章：重积分的变量代换](chapters/chapter-35/index.md) {#chapter-35}

本章学时：7 小时（理论 6，应用 1）。

1. [Jacobian 行列式为什么描述局部面积与体积伸缩？](chapters/chapter-35/u-08-35-01-jacobian-scaling.md)
2. [重积分换元公式需要哪些条件？](chapters/chapter-35/u-08-35-02-change-of-variables.md)
3. [极坐标怎样处理圆形与径向对称区域？](chapters/chapter-35/u-08-35-03-polar-coordinates.md)
4. [柱面、球面坐标怎样处理三维区域？](chapters/chapter-35/u-08-35-04-cylindrical-spherical.md)

### [第 36 章：反常重积分与质量、概率模型](chapters/chapter-36/index.md) {#chapter-36}

本章学时：9 小时（理论 5.75，应用 3.25）。

1. [无界区域上的重积分怎样由极限定义？](chapters/chapter-36/u-08-36-01-unbounded-regions.md)
2. [被积函数有奇点时怎样判断收敛？](chapters/chapter-36/u-08-36-02-singular-integrands.md)
3. [密度怎样产生质量、质心与转动惯量？](chapters/chapter-36/u-08-36-03-mass-centroid-inertia.md)
4. [联合密度怎样产生边缘密度、期望与协方差？](chapters/chapter-36/u-08-36-04-joint-density.md)
5. [怎样为空间累积模型选择区域、坐标与核验方法？](chapters/chapter-36/u-08-36-05-spatial-modeling.md)

### [选读附录：从 Jordan 区域到测度观点](appendices/part-08-jordan-content.md)
...
### [第 37 章：参数曲线与曲线积分](chapters/chapter-37/index.md) {#chapter-37}

本章学时：6 小时（理论 4.5，应用 1.5）。

1. [正则参数曲线怎样描述运动、方向与切向量？](chapters/chapter-37/u-09-37-01-regular-parametric-curves.md)（理论 1.50，应用 0.00）
2. [弧长与第一类曲线积分怎样由参数化定义？](chapters/chapter-37/u-09-37-02-arc-length-scalar-line-integral.md)（理论 1.25，应用 0.25）
3. [第二类曲线积分怎样表示功与环流？](chapters/chapter-37/u-09-37-03-work-circulation.md)（理论 1.00，应用 0.50）
4. [重新参数化、反向与保守场怎样改变积分？](chapters/chapter-37/u-09-37-04-reparameterization-conservative-fields.md)（理论 0.75，应用 0.75）

### [第 38 章：参数曲面与曲面积分](chapters/chapter-38/index.md) {#chapter-38}

本章学时：6 小时（理论 4.5，应用 1.5）。

1. [正则参数曲面怎样产生切平面、法向量与取向？](chapters/chapter-38/u-09-38-01-regular-parametric-surfaces.md)（理论 1.50，应用 0.00）
2. [曲面面积元为什么由叉积的模给出？](chapters/chapter-38/u-09-38-02-surface-area-element.md)（理论 1.25，应用 0.25）
3. [第一类曲面积分怎样累积曲面上的标量分布？](chapters/chapter-38/u-09-38-03-scalar-surface-integral.md)（理论 1.00，应用 0.50）
4. [通量积分怎样依赖参数化与曲面取向？](chapters/chapter-38/u-09-38-04-flux-integral.md)（理论 0.75，应用 0.75）

### [第 39 章：Green 公式与平面场](chapters/chapter-39/index.md) {#chapter-39}

本章学时：6 小时（理论 4.5，应用 1.5）。

1. [平面场的散度与旋度怎样描述局部变化？](chapters/chapter-39/u-09-39-01-planar-divergence-curl.md)（理论 1.50，应用 0.00）
2. [Green 公式怎样从简单区域上的微积分基本定理得到？](chapters/chapter-39/u-09-39-02-green-theorem.md)（理论 1.25，应用 0.25）
3. [分片区域、多连通区域与边界方向怎样处理？](chapters/chapter-39/u-09-39-03-multiply-connected-green.md)（理论 1.00，应用 0.50）
4. [Green 公式怎样控制面积、环流、通量与路径无关？](chapters/chapter-39/u-09-39-04-green-applications.md)（理论 0.75，应用 0.75）

### [第 40 章：Gauss 公式与通量](chapters/chapter-40/index.md) {#chapter-40}

本章学时：6 小时（理论 4.5，应用 1.5）。

1. [三维散度为什么表示局部源汇密度？](chapters/chapter-40/u-09-40-01-spatial-divergence.md)（理论 1.50，应用 0.00）
2. [Gauss 公式为什么先在长方体上成立？](chapters/chapter-40/u-09-40-02-gauss-box.md)（理论 1.25，应用 0.25）
3. [规则区域的分片与内部通量为什么会抵消？](chapters/chapter-40/u-09-40-03-gauss-piecewise-regions.md)（理论 1.00，应用 0.50）
4. [Gauss 公式怎样分析流量、电通量与奇点？](chapters/chapter-40/u-09-40-04-gauss-applications-singularities.md)（理论 0.75，应用 0.75）

### [第 41 章：Stokes 公式与三大公式的统一](chapters/chapter-41/index.md) {#chapter-41}

本章学时：8 小时（理论 6，应用 2）。

1. [三维旋度为什么表示局部环流密度？](chapters/chapter-41/u-09-41-01-spatial-curl.md)（理论 1.50，应用 0.00）
2. [曲面取向怎样诱导边界曲线的正方向？](chapters/chapter-41/u-09-41-02-induced-boundary-orientation.md)（理论 1.25，应用 0.25）
3. [Stokes 公式怎样在单个参数曲面片上证明？](chapters/chapter-41/u-09-41-03-stokes-parametric-patch.md)（理论 1.25，应用 0.25）
4. [分片曲面上的内部边界为什么成对抵消？](chapters/chapter-41/u-09-41-04-stokes-piecewise-surfaces.md)（理论 1.00，应用 0.50）
5. [怎样选择并核验 Green、Gauss 与 Stokes 公式？](chapters/chapter-41/u-09-41-05-vector-theorem-selection.md)（理论 1.00，应用 1.00）
...
1. [区间长度应满足哪些基本性质？](chapters/chapter-46/u-11-46-01-interval-length-axioms.md)
2. [可数区间覆盖怎样定义 Lebesgue 外测度？](chapters/chapter-46/u-11-46-02-outer-measure-definition.md)
3. [外测度为何单调并满足可数次可加性？](chapters/chapter-46/u-11-46-03-outer-measure-properties.md)
...
### [第 48 章：可测函数与收敛方式](chapters/chapter-48/index.md) {#chapter-48}

1. [可测函数为何可由水平集的可测性刻画？](chapters/chapter-48/u-11-48-01-measurable-functions.md)
2. [运算、上确界与逐点极限怎样保持可测性？](chapters/chapter-48/u-11-48-02-measurable-operations-limits.md)
3. [非负可测函数怎样由递增简单函数逼近？](chapters/chapter-48/u-11-48-03-simple-function-approximation.md)
...
第 51–54 章已完整发布：21 个核心单元、33 学时（理论 24，应用 9），未超过
34 学时硬上限。
...
### [第 52 章：Fourier 系数与逐点收敛](chapters/chapter-52/index.md) {#chapter-52}

1. [Fourier 系数有哪些平移、伸缩与对称性质？](chapters/chapter-52/u-12-52-01-symmetry-transformations.md)
2. [奇偶性和分段积分怎样简化系数计算？](chapters/chapter-52/u-12-52-02-coefficient-calculation.md)
3. [半区间正弦展开与余弦展开怎样选择？](chapters/chapter-52/u-12-52-03-half-range-expansions.md)
4. [Fourier 部分和怎样写成 Dirichlet 核卷积？](chapters/chapter-52/u-12-52-04-dirichlet-kernel.md)
