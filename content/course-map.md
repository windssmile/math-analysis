...
截至第 39 章共 177 个学习单元、323 学时。历史发布里程碑包括第 27 章，共 122 个学习单元，
...
本章规划 6 学时（理论 4.5，应用 1.5）。

1. `u-09-40-01` 三维散度为什么表示局部源汇密度？（理论 1.50，应用 0.00）
2. `u-09-40-02` Gauss 公式为什么先在长方体上成立？（理论 1.25，应用 0.25）
3. `u-09-40-03` 规则区域的分片与内部通量为什么会抵消？（理论 1.00，应用 0.50）
4. `u-09-40-04` Gauss 公式怎样分析流量、电通量与奇点？（理论 0.75，应用 0.75）
