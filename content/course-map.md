...
截至第 36 章共 165 个学习单元、305 学时。历史发布里程碑包括第 27 章，共 122 个学习单元，
...
第九部规划 21 个核心单元、32 学时（理论 24，应用 8）。以下条目均为规划中；
当前发布边界仍是第 36 章，因此不创建正文页面或导航入口。

### 第 37 章：参数曲线与曲线积分（规划中）

本章规划 6 学时（理论 4.5，应用 1.5）。

1. `u-09-37-01` 正则参数曲线怎样描述运动、方向与切向量？（理论 1.50，应用 0.00）
2. `u-09-37-02` 弧长与第一类曲线积分怎样由参数化定义？（理论 1.25，应用 0.25）
3. `u-09-37-03` 第二类曲线积分怎样表示功与环流？（理论 1.00，应用 0.50）
4. `u-09-37-04` 重新参数化、反向与保守场怎样改变积分？（理论 0.75，应用 0.75）
