...
截至第 40 章共 181 个学习单元、329 学时。历史发布里程碑包括第 27 章，共 122 个学习单元，
...
第九部规划 21 个核心单元、32 学时（理论 24，应用 8）。当前发布第 37–39 章；
第 40–41 章仍为规划中，不创建正文页面或导航入口。
...
1. `u-09-41-01` 三维旋度为什么表示局部环流密度？（理论 1.50，应用 0.00）
2. `u-09-41-02` 曲面取向怎样诱导边界曲线的正方向？（理论 1.25，应用 0.25）
3. `u-09-41-03` Stokes 公式怎样在单个参数曲面片上证明？（理论 1.25，应用 0.25）
4. `u-09-41-04` 分片曲面上的内部边界为什么成对抵消？（理论 1.00，应用 0.50）
5. `u-09-41-05` 怎样选择并核验 Green、Gauss 与 Stokes 公式？（理论 1.00，应用 1.00）
