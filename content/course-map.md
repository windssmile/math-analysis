...
截至第 37 章共 169 个学习单元、311 学时。历史发布里程碑包括第 27 章，共 122 个学习单元，
...
第九部规划 21 个核心单元、32 学时（理论 24，应用 8）。当前发布第 37 章；
第 38–41 章仍为规划中，不创建正文页面或导航入口。
...
1. `u-09-38-01` 正则参数曲面怎样产生切平面、法向量与取向？（理论 1.50，应用 0.00）
2. `u-09-38-02` 曲面面积元为什么由叉积的模给出？（理论 1.25，应用 0.25）
3. `u-09-38-03` 第一类曲面积分怎样累积曲面上的标量分布？（理论 1.00，应用 0.50）
4. `u-09-38-04` 通量积分怎样依赖参数化与曲面取向？（理论 0.75，应用 0.75）
